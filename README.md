...
| **Tools & Techniques** | <ul><li>**Python**: Data Sampling (Stratified method using Scikit-learn)</li><li>**Power Query**: Creating Index, Filtering Rows</li><li>**Power BI**: User-friendly dashboard</li><li>**DAX Functions**: Time-Based Aggregation, Dense-Ranking, Sorting, Concatenation (using a dot separator), Calculated Columns</li></ul> |
